...
export default function EditInvoicePage({ params }: { params: Promise<{ id: string }> }) {
  ...
  useEffect(() => {
    async function loadInvoice() {
      ...
      setSellerPhone(inv.seller_phone || '')
      setSellerEmail(inv.seller_email || '')
      ...
      setDueDate(inv.due_date || dueDefault)
      setPlaceOfSupply(inv.place_of_supply || 'Gujarat')
      setGstType(inv.gst_type || 'cgst')
    ...
    <div className="flex min-h-screen bg-zinc-950">
      ...
      <div className="w-[420px] shrink-0 bg-zinc-900 border-r border-zinc-800 overflow-y-auto h-screen sticky top-0">
        <div className="p-6 border-b border-zinc-800 flex items-center justify-between">
          <h2 className="font-syne font-black text-lg">Edit Invoice <span className="text-zinc-600 font-mono text-xs ml-1">संपादित करें</span></h2>
        ...
        <div className="p-6 space-y-8 pb-24">
          ...
          <Section label="Your Business" hi="आपका बिज़नेस">
            ...
            <Field label="GSTIN"><input value={sellerGSTIN} onChange={e => setSellerGSTIN(e.target.value)} placeholder="27AAPFU0939F1ZV" maxLength={15} className={`${inp} font-mono tracking-widest`}/></Field>
          ...
          <Section label="Bill To" hi="ग्राहक">
            ...
            <Field label="GSTIN (optional)"><input value={buyerGSTIN} onChange={e => setBuyerGSTIN(e.target.value)} placeholder="Customer GSTIN" maxLength={15} className={`${inp} font-mono tracking-widest`}/></Field>
