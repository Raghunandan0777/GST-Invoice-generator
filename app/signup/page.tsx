    ...
    return (
      <div className="min-h-screen bg-zinc-950 flex items-center justify-center p-4">
        <div className="text-center max-w-md">
          ...
          <h2 className="font-syne font-black text-2xl mb-3">Check your email!</h2>
          ...
          <Link href="/login" className="text-amber-400 hover:underline text-sm">Back to login →</Link>
        </div>
      </div>
    )
  }
    ...
    <div className="min-h-screen bg-zinc-950 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-zinc-400 mt-2 text-sm">Create your free account / मुफ़्त खाता बनाएं</p>
        </div>
        <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-8">
          ...
          <form onSubmit={handleSignup} className="space-y-4">
            ...
            <div>
              <label className="block text-xs text-zinc-500 font-mono uppercase tracking-wider mb-1.5">Full Name / पूरा नाम</label>
            ...
            <button type="submit" disabled={loading}
              className="w-full bg-amber-400 text-black font-syne font-bold py-3 rounded-xl hover:bg-amber-300 transition-colors disabled:opacity-50">
